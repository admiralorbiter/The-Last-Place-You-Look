...
|---|---|---|
| What is the minimum target dataset size the scan pipeline must handle acceptably? (e.g., 50k files? 200k files?) | Epic 3 | Target 50k files comfortably; 200k as a stretch. Establish this before hardening. |
